                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            ...
                            <h4 class="font-weight-semibold" id="acceptance-of-the-terms-of-use">Acceptance of the Terms of Use</h4>

                            <p class="text-justify">
                                These terms of use are entered into by and between You and {{ $app_name }} ("we" or "us").
                                The following terms and conditions and all documents incorporated by reference
                                (collectively, "Terms of Use"), govern your access to and use of <a target="_blank" href="{{ $app_url }}">{{ $app_url }}</a>,
                                including any content, functionality and services offered on or through <a target="_blank" href="{{ $app_url }}">{{ $app_url }}</a> (the "Website").
                            </p>
                            ...
                            <p class="text-justify">
                                ...
                                Privacy Policy, found at <a target="_blank" href="{{ route('privacy_policy') }}">{{ route('privacy_policy') }}</a>,
                            ...
                            <h4 class="font-weight-semibold" id="changes-to-the-terms-of-use">Changes To The Terms Of Use</h4>
                            ...
                            <h4 class="font-weight-semibold" id="accessing-the-website-and-account-security">Accessing The Website And Account Security</h4>
                            ...
                            <ul class="list-style-circle text-justify">
                            ...
                            <h4 class="font-weight-semibold" id="intellectual-property-rights">Intellectual Property Rights</h4>
                            ...
                            <p class="text-justify">
                                These Terms of Use permit you to use the Website for your personal, or ogranizational,
                                non-commercial use
                                ...
                                on our Website in violation of any laws.
                            </p>
                            ...
                            <h4 class="font-weight-semibold" id="trademarks">Trademarks</h4>

                            <p class="text-justify">
                                The {{ $app_name }} name and all related names, logos, slogans, mottos, and designs
                            ...
                            <h4 class="font-weight-semibold" id="prohibited-uses">Prohibited Uses</h4>
                            ...
                            <ul class="list-style-circle text-justify">
                                ...
                                <li>
                                    To impersonate or attempt to impersonate us, one of our employees, another user or
                            ...
                            <ul class="list-style-circle text-justify">
                                ...
                                <li>
                                    Use the Website in any manner that violates any applicable {{ $app_name }} policy, rule, or procedure.
                                </li>
                                <li>
                                    Use the Website in any manner that contravenes Catholic Mercy tradition, faith, and
                                    morals or the legacy of Catholic Mercy education.
                                </li>
                                <li>Otherwise attempt to interfere with the proper working of the Website.</li>
                            </ul>

                            <h4 class="font-weight-semibold" id="user-contributions">User Contributions</h4>
                            ...
                            <h4 class="font-weight-semibold" id="monitoring-and-enforcement-termination">Monitoring And Enforcement; Termination</h4>
                            ...
                            <p class="text-justify">
                                YOU WAIVE AND HOLD HARMLESS {{ strtoupper($app_name) }} FROM ANY CLAIMS RESULTING FROM
                                ...
                                {{ strtoupper($app_name) }} OR LAW ENFORCEMENT AUTHORITIES.
                            </p>

                            <p class="text-justify">
                                However, we do not undertake to review all material before it is posted on the Website,
                            ...
                            <h4 class="font-weight-semibold" id="content-standards">Content Standards</h4>
                            ...
                            <ul class="list-style-circle text-justify">
                                ...
                                <li>
                                    ...
                                    Terms of Use and our <a target="_blank" href="{{ route('privacy_policy') }}">Privacy Policy</a>.
                                </li>
                            ...
                            <h4 class="font-weight-semibold" id="copyright-infringement">Copyright Infringement</h4>
                            ...
                            <p class="text-justify">
                                ...
                                compliance with the <a target="_blank" href="{{ route('privacy_policy') }}">Privacy Policy</a>.
                            </p>

                            <h3>Article II</h3>

                            <h4 class="font-weight-semibold" id="linking-to-the-website-and-social-media-features">Linking to the Website and Social Media Features</h4>
                            ...
                            <p class="text-justify">
                                You agree to cooperate with us in removing any link we ask you to. We reserve the right
                            ...
                            <h4 class="font-weight-semibold" id="links-from-the-website">Links from the Website</h4>
                            ...
                            <h4 class="font-weight-semibold" id="declaimer-of-warranties">Disclaimer of Warranties</h4>
                            ...
                            <p>
                                {{ strtoupper($app_name) }} HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS
                                OR IMPLIED, STATUTORY OR OTHERWISE, INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF NON-INFRINGEMENT.
                            </p>

                            <p>THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.</p>

                            <h4 class="font-weight-semibold" id="limitation-on-liability">Limitation on Liability</h4>

                            <p class="text-justify">
                                IN NO EVENT WILL {{ strtoupper($app_name) }}, ITS AFFILIATES OR THEIR LICENSORS, SERVICE
                            ...
                            <h4 class="font-weight-semibold" id="indemnification">Indemnification</h4>

                            <p class="text-justify">
                                You agree to defend, indemnify and hold harmless {{ $app_name }}, its affiliates,
                            ...
                            <h4 class="font-weight-semibold" id="governing-law-and-jurisdiction">Governing Law and Jurisdiction</h4>
                            ...
                            <p class="text-justify">
                                ...
                                or claims), shall be governed by and construed in accordance with the laws of Tanzania
                            ...
                            <h4 class="font-weight-semibold" id="arbitration">Arbitration</h4>

                            <p class="text-justify">
                                At {{ $app_name }}’s sole discretion, it may require You to submit any disputes
                            ...
                            <h4 class="font-weight-semibold" id="limitation-on-time-to-file-claims">Limitation on Time to File Claims</h4>
                            ...
                            <h4 class="font-weight-semibold" id="waiver-and-severability">Waiver and Severability</h4>

                            <p class="text-justify">
                                No waiver of by {{ $app_name }} of any term or condition set forth in these Terms of
                            ...
                            <h4 class="font-weight-semibold" id="entire-agreement">Entire Agreement</h4>

                            <p class="text-justify">
                                These Terms of Use and our <a target="_blank" href="{{ route('privacy_policy') }}">Privacy Policy</a> constitute the sole and
                            ...
                            <h5 class="font-weight-semibold" id="your-comments-and-concerns">Your Comments and Concerns</h5>
                            <p class="text-justify">
                                If you do have any comments or concerns regarding but not limited to these Terms of Use.
                                Please contact us.
                            </p>
                            ...
                            <p class="text-justify">
                                ...
                                relating to the Website should be directed to the
                                <a href="javascript:;" id="contact-link" data-toggle="modal" data-target="#admin-contact-modal"> {{ "School Administrator" }}</a>.
                            </p>
                        </div>
                    </div>
                </div>
