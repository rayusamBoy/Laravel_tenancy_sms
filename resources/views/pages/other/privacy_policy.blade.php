                ...
                <div class="card-body">
                    <div class="row">
                        <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                            <p class="float-right">Last modified: Janury 1, 2022</p>
                            ...
                            <p>This policy describes the types of information we may collect (or have collected) from
                            ...
                            <ul>
                                ...
                                <li>Automatically as you navigate through the site. Information collected automatically
                                    may include usage details, IP addresses, and information collected through cookies
                                    or other tracking technologies.</li>
                            </ul>

                            <h4 class="font-weight-semibold">Information You Provide to Us. The information we collect
                                on or through our Website may include:</h4>

                            <ul>
                                <li>Information that you provide (or provided) by filling in forms or on our Website.
                                    ...
                                    is used only for the purpose stated at the time of collection.</li>
                                <li>Records and copies of your correspondence (including email addresses), if you
                                    contact us.</li>
                            </ul>

                            <h4 class="font-weight-semibold">Information We Collect Through Automatic Data Collection
                                Technologies:</h4>
                            ...
                            <ul>
                                <li><strong>Cookies</strong> (or browser cookies). A cookie is a small file placed on
                                ...
                                <li><strong>Flash Cookies.</strong> Certain features of our Website may use local stored
                            ...
                            <p>It is our policy to post any changes we make to our privacy policy on this page. If we
                            ...
                            <p>To ask questions or comment about this privacy policy and our privacy practices, please
