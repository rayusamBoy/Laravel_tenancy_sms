                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            ...
                            <p class="text-justify">
                                This policy describes the types of information we may collect (or have collected) from
                                you or that you may provide when you visit the website
                                <a target="_blank" href="{{ $app_url }}">{{ $app_url }}</a> (our "Website")
                            ...
                            <h4 class="font-weight-semibold" id="information-we-collect-about-you-and-how-we-collect-it">Information We Collect About You and How We Collect It</h4>
                            ...
                            <h4 class="font-weight-semibold" id="information-you-provide-to-us">Information You Provide to Us:</h4>
                            <p>The information we collect on or through our Website may include:</p>

                            <ul class="list-style-circle text-justify">
                                <li>
                                    Information that you provide (or provided) by filling in forms or on our Website.
                                    Personal information submitted will not be transferred to any third parties unless
                                    otherwise stated at the time of collection. When you submit personal information, it
                                    is used only for the purpose stated at the time of collection.
                                </li>
                                <li>
                            ...
                            <h4 class="font-weight-semibold" id="information-we-collect-through-automatic-data-collection-technologies">Information We Collect Through Automatic Data Collection Technologies:</h4>
                            ...
                            <p class="text-justify">
                                ...
                                information, and we may maintain it or associate it with personal information we collect
                            ...
                            <ul class="list-style-circle text-justify">
                                <li>
                                    <strong>Cookies</strong> (or browser cookies). A cookie is a small file placed on
                                    ...
                                    setting you may be unable to access certain parts of our Website. Unless you have
                                ...
                                <li>
                                    <strong>Flash Cookies.</strong> Certain features of our Website may use local stored
                                    objects (or Flash cookies) to collect and store information about your preferences
                                    and navigation to, from, and on our Website. Flash cookies are not managed by the
                                    same browser settings as are used for browser cookies. For information about
                                    managing your privacy and security settings for Flash cookies, see Choices About How
                                    We Use and Disclose Your Information.
                                </li>
                                <li>
                                    <strong>Web Beacons.</strong> Pages of our Website may contain small electronic
                            ...
                            <h4 class="font-weight-semibold" id="how-we-use-your-information">How We Use Your Information</h4>

                            <p>We use information that we collect about you or that you provide to us, including any personal information:</p>

                            <ul class="list-style-circle text-justify">
                                <li>For School Management purposes as described in the inttroductory section.</li>
                            ...
                            <h4 class="font-weight-semibold" id="disclosure-of-your-information">Disclosure of Your Information</h4>
                            ...
                            <ul class="list-style-circle text-justify">
                                ...
                                <li>
                                    To enforce or apply our <a target="_blank" href="{{ route('terms_of_use') }}">Terms of Use</a>.
                                </li>
                                <li>
                            ...
                            <h4 class="font-weight-semibold" id="choices-about-how-we-use-and-disclosure-your-information">Choices About How We Use and Disclose Your Information</h4>
                            ...
                            <h4 class="font-weight-semibold" id="data-security">Data Security</h4>
                            ...
                            <h4 class="font-weight-semibold" id="changes-to-our-privacy-policy">Changes to Our Privacy Policy</h4>
                            ...
                            <h4 class="font-weight-semibold" id="contact-information">Contact Information</h4>

                            <p class="text-justify">To ask questions or comment about this privacy policy and our privacy practices, please call {{ $contact_phone }}.</p>
                        </div>
                    </div>
                </div>
