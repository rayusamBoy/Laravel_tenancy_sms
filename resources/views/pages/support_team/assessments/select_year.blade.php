...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="material-symbols-rounded mr-2">article</i> Select Exam Year</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form method="post" action="{{ route('assessments.year_select', $student_id) }}">
                        @csrf
