    ...
    <div class="container">
        <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
            ...
            <div style="position: relative;  text-align: center; ">
                <img src="{{ $settings->where('type', 'logo')->value('description') }}" style="max-width: 500px; max-height:600px; margin-top: 60px; position:absolute ; opacity: 0.2; margin-left: auto;margin-right: auto; left: 0; right: 0;" />
            </div>
