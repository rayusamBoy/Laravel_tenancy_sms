                ...
                <div class="col-md-8">
                    <form class="ajax-store" method="post" action="{{ route('ttr.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select required data-placeholder="Select Class First" class="form-control select" name="section_id" id="section_id"></select>
                            </div>
                        </div>
                            ...
                            <td class="text-center">
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            {{--View--}}
                                            <a href="{{ route('ttr.show', $ttr->id) }}" class="dropdown-item"><i class="material-symbols-rounded">visibility</i> View</a>

                                            @if(Qs::userIsTeamSA())
                                            {{--Manage--}}
                                            <a href="{{ route('ttr.manage', $ttr->id) }}" class="dropdown-item"><i class="material-symbols-rounded">manage_search</i> Manage</a>
                                            {{--Edit--}}
                                            <a href="{{ route('ttr.edit', $ttr->id) }}" class="dropdown-item"><i class="material-symbols-rounded">edit</i> Edit</a>
                                            @endif
