                    ...
                    <div class="col-md-12">
                        <form method="post" action="{{ route('tt.update', $tt->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input autocomplete="off" name="exam_date" value="{{ $tt->exam_date }}" required type="text" class="form-control date-pick" placeholder="Select Date...">
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary">Submit Form <i class="material-symbols-rounded ml-2">send</i>
                                </button>
                            </div>
                        </form>
                    </div>
