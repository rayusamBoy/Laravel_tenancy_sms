        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="used-pins">
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info border-0 alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
                            <div class="text-center"> <span>A total of <strong>{{ $used_pins->count() }}</strong> pin(s) have been used and may no longer be valid </span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    @if($used_pins->isNotEmpty())
                    <div class="col-md-12">
                        <a id="used-pins" onclick="confirmDelete(this.id)" href="javascript:;" class="btn btn-danger btn-sm ml-2 float-right"><i class="material-symbols-rounded mr-1">delete</i> Delete ALL Used Pins</a>
