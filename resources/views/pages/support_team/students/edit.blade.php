    ...
    <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('students.update', Qs::hash($sr->id)) }}" data-fouc>
        ...
        <fieldset>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $sr->user->name }}" required type="text" name="name" placeholder="Full Name" class="form-control text-uppercase">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="display-i-on-hover w-100">Food Taboos:
                        ...
                        <input type="text" name="food_taboos" placeholder="Mention (if presents)" class="form-control" value="{{ $sr->food_taboos }}">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input name="ps_name" value="{{ $sr->ps_name ?? '' }}" type="text" class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input name="ss_name" value="{{ $sr->ss_name ?? '' }}" type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="house_no" placeholder="House number" class="form-control text-uppercase" value="{{ $sr->house_no }}">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="chp" placeholder="Mention (if presents)" class="form-control" value="{{ $sr->chp }}">
                    </div>
                </div>
            </div>
        </fieldset>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select data-placeholder="Choose..." name="dorm_id" id="dorm_id" class="select-search form-control">
                        <option value=""></option>
                        @foreach($dorms as $d)
                        <option title="{{ $d->description }}" {{ ($sr->dorm_id == $d->id) ? 'selected' : '' }} value="{{ $d->id }}">{{ $d->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="adm_no" placeholder="Admission Number" class="form-control" value="{{ $sr->adm_no }}">
                    </div>
                </div>
            </div>
        </fieldset>
