    ...
    <div class="container">
        <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
            ...
            <table width="100%">
                <tr>
                    <td>
                        <strong><span style="color: #1b0c80; font-size: 25px;">{{ strtoupper($settings->where('type', 'system_name')->value('description')) }}</span></strong><br />
                        <strong><span style="color: #1b0c80; font-size: 20px;">{{ ucwords($settings->where('type', 'address')->value('description')) }}</span></strong>
            ...
            <div style="position: relative;  text-align: center; ">
                <img src="{{ tenant_asset($settings->where('type', 'logo')->value('description')) }}" style="max-width: 500px; max-height:600px; margin-top: 60px; position: absolute; opacity: 0.05; margin-left: auto; margin-right: auto; left: 0; right: 0;" />
            </div>
            ...
            <div style="margin: 15px;">
                <img style="width: 100px; height: 100px; float: left;" src="{{ Usr::getTenantAwarePhoto($sr->user->photo) }}" alt="...">
            </div>
