...
var DatatableButtonsHtml5 = (function () {
    ...
    var _componentDatatableButtonsHtml5 = function () {
        ...
        $(".datatable-button-html5-basic").DataTable({
            buttons: {
                ...
                buttons: [
                    ...
                    {
                        extend: "colvis",
                        text: '<i class="material-symbols-rounded">visibility</i> Visibility',
        ...
        // Datatable with only filter and show
        $(".datatable").DataTable({
            buttons: [
                {
                    className: "d-none",
                ...
                buttons: [
                    {
                        extend: "copyHtml5",
                        className: "btn btn-light",
                        text: '<i class="material-symbols-rounded mr-2">content_copy</i> Copy',
                    },
                    {
                        extend: "csvHtml5",
                        className: "btn btn-light",
                        text: '<i class="material-symbols-rounded mr-2">csv</i> CSV',
                        fieldSeparator: "\t",
                        extension: ".tsv",
                    },
                ],
